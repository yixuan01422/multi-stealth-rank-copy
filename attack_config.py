...
IMAGE_ATTACK_PARAMS = {
    'epsilon': 0.15,              # Maximum perturbation bound
    'alpha': 0.01,                # Step size for PGD attack
    'num_steps': 200,             # Number of PGD iterations
    'mask_type': 'spatial',       # Mask type: 'spatial' or 'value_based'
    'object_perturbation_ratio': 0.15,  # Scaling factor for object regions in spatial mask
}
